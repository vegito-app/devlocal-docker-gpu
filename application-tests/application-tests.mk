...
APPLICATION_TESTS_IMAGE_DOCKER_BUILDX_LOCAL_CACHE=$(CURDIR)/.containers/docker-buildx-cache/application-tests
...
local-application-tests-docker-compose-up: local-application-tests-docker-compose-rm
	@VERSION=latest $(CURDIR)/application-tests/docker-compose-up.sh &
